...
describe("Create area", function () {
  ...
  it("Create an area while being logged with the correct data should return the created area (happy case)", async function () {
    ...
    const geojson =
      '{"type":"Polygon","coordinates":[[[80.57519943543053,9.48478783138593],[80.56375534418066,9.473895081628044],[80.57608635341853,9.466049831323232],[80.58481247244907,9.477507223783533],[80.57519943543053,9.48478783138593]]]}';
        ...
        features: [
          {
            geometry: {
              coordinates: [
                [
                  [80.575199435, 9.484787831],
                  [80.563755344, 9.473895082],
                  [80.576086353, 9.466049831],
                  [80.584812472, 9.477507224],
                  [80.575199435, 9.484787831]
                ]
              ],
              type: "Polygon"
    ...
    nock(config.get("geostoreAPI.url"))
      .post("/geostore", {
        geojson: {
          ...
          coordinates: [
            [
              [80.57519943543053, 9.48478783138593],
              [80.56375534418066, 9.473895081628044],
              [80.57608635341853, 9.466049831323232],
              [80.58481247244907, 9.477507223783533],
              [80.57519943543053, 9.48478783138593]
            ]
          ]
        },
    ...
    nock(config.get("geostoreAPI.url"))
      ...
      .query({
        ...
        slugs: "umd_as_it_happens"
      })
      .reply(200, {
        data: {
          type: "coverages",
          attributes: { layers: ["umd_as_it_happens"] }
        }
      });
